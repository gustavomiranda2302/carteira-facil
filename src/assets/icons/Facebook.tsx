...
export default function Facebook({ className, size = 24 }: FacebookProps) {
    return (
        <svg width={size} height={size} className={className} viewBox="0 0 64 64" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
